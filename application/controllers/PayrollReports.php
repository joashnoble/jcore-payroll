    ...
    function payrollreports($payrollreports=null,$filter_value=null,$filter_value2=null,$filter_value3=null,$type=null){
        ...
        switch($payrollreports){
            ...
            case 'payroll-employee-ledger': //
                        ...
                        $data['loans']=$this->PayrollReports_model->getloan($filter_value,$filter_value2,$start_date,$end_date);
                        $data['initial_loan']=$this->PayrollReports_model->getInitialLoan($filter_value,$filter_value2);

                        $data['loan_amount']=$this->PayrollReports_model->getloanamount($filter_value,$filter_value2);
                        $loans = $data['loans'];
            ...
            case 'payroll-loan-amount-get': //
                    ...
                    if($loan_total_amount[0]->count==0 || $loan_total_amount[0]->count==null){
                        ...
                        $response['balance']=$loan_total_amount[0]->balance;
                        echo json_encode($response);
                    }
            break;
            ...
            case 'alpha_list':
                ...
                $data['alpha_list']=$this->PayrollReports_model->get_alpha_list($filter_value,$start_13thmonth_date,$end_13thmonth_date,$factor,$filter_value2);
            ...
            case 'report1601C':
                ...
                $data['company']=$getcompany[0];
                $data['report1601C']=$this->PayrollReports_model->get_1601C_list($year,$month);
                $data['year']=$year;
            ...
            case 'monthlyworkedhours':
                ...
                $data['company']=$getcompany[0];
                $data['mwh']=$this->PayrollReports_model->get_monthly_worked_hours($year,$month);
                $data['year']=$year;
                ...
                echo $this->load->view('template/monthly_worked_hours_html',$data,TRUE);
            ...
            case 'monthlyloan':
                ...
                $data['company']=$getcompany[0];
                $data['loans']=$this->PayrollReports_model->get_monthly_loan($year,$month,$loan_id);
                $data['year']=$year;

                $getloan = $this->RefDeductionSetup_model->get_list($loan_id);
                $data['loan_type'] = $getloan[0]->deduction_desc;
                ...
                echo $this->load->view('template/monthly_loan_html',$data,TRUE);
