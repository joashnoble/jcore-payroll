                    ...
                    if($result->num_rows()>0){//valid username and pword
                        ...
                        $this->session->set_userdata(
                            array(
                                ...
                                'right_employeeclearance_view'=>$result->row()->right_employeeclearance_view,
                                'right_employeeclearance_create'=>$result->row()->right_employeeclearance_create,
                                'right_employeeclearance_edit'=>$result->row()->right_employeeclearance_edit,
                                'right_employeeclearance_delete'=>$result->row()->right_employeeclearance_delete,
				'right_employeeclearance_finalize'=>$result->row()->right_employeeclearance_finalize,
                                'right_clearancereason_view'=>$result->row()->right_clearancereason_view,
                                'right_clearancereason_create'=>$result->row()->right_clearancereason_create,
                                'right_clearancereason_edit'=>$result->row()->right_clearancereason_edit,
                                'right_clearancereason_delete'=>$result->row()->right_clearancereason_delete,
