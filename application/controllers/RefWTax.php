        ...
        switch ($txn) {
            ...
            case 'taxMonthly':
            	$response['data']=$this->RefPayment_model->get_list(
            		array('ref_payment_type.is_deleted'=>FALSE,'ref_payment_type.ref_payment_type_id'=>2),
            			'ref_payment_type.*');
          		echo json_encode($response);
          	...
          	case 'taxSemiMonthly':
            	$response['data']=$this->RefPayment_model->get_list(
            		array('ref_payment_type.is_deleted'=>FALSE,'ref_payment_type.ref_payment_type_id'=>1),
            			'ref_payment_type.*');
          		echo json_encode($response);
          	...
          	case 'taxWeekly':
            	$response['data']=$this->RefPayment_model->get_list(
            		array('ref_payment_type.is_deleted'=>FALSE,'ref_payment_type.ref_payment_type_id'=>4),
            			'ref_payment_type.*');
          		echo json_encode($response);
          	...
          	case 'taxDaily':
            	$response['data']=$this->RefPayment_model->get_list(
            		array('ref_payment_type.is_deleted'=>FALSE,'ref_payment_type.ref_payment_type_id'=>3),
            			'ref_payment_type.*');
          		echo json_encode($response);
