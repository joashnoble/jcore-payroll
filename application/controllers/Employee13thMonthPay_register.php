...
class Employee13thMonthPay_register extends CORE_Controller
{

    function __construct() {
        parent::__construct('');
        $this->validate_session();
        // if($this->session->userdata('right_13thmonthpay_register_view') == 0 || $this->session->userdata('right_13thmonthpay_register_view') == null) {
        //     redirect('../Dashboard');
        // }
    ...
    public function index() {
        ...
        $data['title'] = '13th Month Pay Register';

        $this->load->view('employee_13thmonthpay_register_view', $data);
    }
