...
class EmployeePayrollRegisterCash extends CORE_Controller
{

    function __construct() {
        parent::__construct('');
        $this->validate_session();
        if($this->session->userdata('right_payroll_register_cash_view') == 0 || $this->session->userdata('right_payroll_register_cash_view') == null) {
            redirect('../Dashboard');
        }
    ...
    public function index() {
        ...
        $data['title'] = 'Employee Payroll Register Cash';

        $this->load->view('payroll_register_cash_view', $data);
    }
