    ...
    function transaction($txn = null) {
        switch ($txn) {
            ...
            case 'create':
                ...
                $m_rdc = $this->Reg_deduction_cycle_model;
                ...
                $m_payperiod->pay_period_year = $this->input->post('pay_period_year', TRUE);
                ...
                $get_ndr = $m_payperiod->get_ndr($pay_period_start,$pay_period_end);

                for ($i=0; $i < count($get_ndr); $i++) { 
                    $m_rdc->deduction_regular_id = $get_ndr[$i]->deduction_regular_id;
                    $m_rdc->pay_period_id = $pay_period_id;
                    $m_rdc->save();
                }
