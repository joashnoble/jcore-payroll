...
class PayrollReports_model extends CORE_Model {
   ...
   function get_1601C_list($year,$month){
    ...
    function get_alpha_list($filter_value,$start_date,$end_date,$factor) {
            $query = $this->db->query("SELECT
                                        last_name,
                                        first_name,
                                        middle_name,
                                        ...
                                        tin,
                                        getwtax.wtax,
                                        get13thmonth.acc_13thmonth_pay,
                                    ...
                                    FROM
                                        ...
                                        (SELECT
                                            ((SUM(dtr.for_13th_month)-(SUM(ps.days_wout_pay_amt)))/".$factor.") as acc_13thmonth_pay, 
                                            dtr.employee_id
                                        FROM
                                            pay_slip as ps
                                        ...
                                        WHERE
                                            ((rpp.pay_period_start BETWEEN '".$start_date."' AND '".$end_date."') OR 
                                                (rpp.pay_period_end BETWEEN '".$start_date."' AND '".$end_date."'))
                                        GROUP BY employee_id) AS get13thmonth ON get13thmonth.employee_id = employee_list.employee_id
