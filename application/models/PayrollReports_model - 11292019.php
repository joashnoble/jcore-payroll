...
class PayrollReports_model extends CORE_Model {
   ...
   function get_1601C_list($year,$month){
    ...
    function get_13thmonthpay_employee_filter($filter_value,$filter_value3,$start_date,$end_date) {
            //1=allowance 2=salary adjustments 3=meal allowance 4=other allowance 5=commision
    ...
    function get_alpha_list($filter_value,$start_date,$end_date,$factor) {
            $query = $this->db->query("SELECT
                                    ...
                                    FROM
                                        ...
                                        (SELECT
                                            (((SUM(dtr.for_13th_month)) + (SUM(ps.days_with_pay_amt)) - (SUM(ps.days_wout_pay_amt)))/".$factor.") as acc_13thmonth_pay, 
                                            dtr.employee_id
                                        FROM
                                            pay_slip as ps
