    ...
    function get_alpha_list($filter_value,$start_date,$end_date,$factor,$status='all') {
            $query = $this->db->query("SELECT
                                    ...
                                    FROM
                                        ...
                                        (SELECT emp_13thmonth.grand_13thmonth_pay, emp_13thmonth.employee_id  FROM emp_13thmonth WHERE year = ".$filter_value.") AS get13thmonth ON get13thmonth.employee_id = employee_list.employee_id
