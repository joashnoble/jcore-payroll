                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body table-responsive">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <button type="button" class="btn col-sm-12 form-control" id="print_philhealth_list" style="background-color:#27ae60; color:white;width: 100px;margin-top: 25px;">
                                                <i class="fa fa-print"></i> PRINT
                                            </button>
                                            <button type="button" class="btn col-sm-12 btn-primary form-control" id="export_philhealth_list" style="color:white;margin-left: 5px;margin-top: 25px;width: auto;"><i class="fa fa-file-excel-o"></i> EXPORT EXCEL
                                            </button>
                                            <button type="button" class="btn col-sm-12 btn-info form-control" id="email_philhealth_list" style="color:white;margin-left: 5px;margin-top: 25px; width: 100px;">
...
$(document).ready(function(){
    ...
    $('#export_philhealth_list').on('click', function() {
        ...
        window.open("Hris_Reports/reports/export-philhealth-list/"+filter_branch+"/"+filter_month+"/"+filter_pay_period+"","_self");
    });

    $('#email_philhealth_list').on('click', function() {
        filter_pay_period = $('#payperiod_filter').val();
        filter_branch = $('#branch_filter_list').val();
        filter_month = $('#month_filter').val();
    ...
    $.ajax({
        "dataType":"json",
        "type":"POST",
        "url":"Hris_Reports/reports/email-philhealth-list/"+filter_branch+"/"+filter_month+"/"+filter_pay_period+"",
