            ...
            <div class="static-content" >
                <div class="page-content">
                    ...
                    <ol class="breadcrumb" style="margin-bottom:0px;">
                        ...
                        <li><a href="EmployeeMonthlyPayrollSalary">Employee Payroll Summary</a></li>
                    </ol>
                                    ...
                                    <div style="margin-left: 20px;">
                                      <div class="row">
                                          ...
                                          <div class="col-md-3">
                                              ...
                                              <select class="form-control" style="margin-left: 20px;" name="department_filter" id="department_filter" data-error-msg="Department Filter is required" required>
                                       ...
                                       <div class="row" style="margin-top: 10px;">
                                        <div class="col-md-3">
                                            <button type="button" class="btn col-sm-12 form-control" id="print_emp_payroll_summary" style="background-color:#27ae60; color:white;margin-left: 20px; width: 200px;">PRINT</button>
                                        </div>
                                    </div>
                                    <hr>
