                                ...
                                <div class="panel-body table-responsive">
                                    <div style="margin: 20px;">
                                      <div class="row">
                                          ...
                                          <div class="col-md-3">
                                            <button type="button" class="btn col-sm-12 form-control" id="print_13month_pay" style="background-color:#27ae60; color:white;">
                                                <i class="fa fa-print"></i> PRINT
                                            </button> <br/>
                                            
                                            <button type="button" class="btn btn-primary col-sm-12 form-control" id="export_13month_pay" style="background-color:#27ae60; color:white;margin-top: 5px;">
