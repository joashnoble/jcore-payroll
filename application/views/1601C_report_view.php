            ...
            <div class="static-content" >
                <div class="page-content">
                    <ol class="breadcrumb" style="margin-bottom:0px;">
                        ...
                        <li><a href="Report1601C">1601C Report</a></li>
                    </ol>
                        ...
                        <div id="div_2316_list">
                            <div class="panel panel-default">
                                <div class="panel-heading" style="background-color:#2c3e50 !important;margin-top:2px;">
                                     <center><h2 style="color:white;font-weight:300;">1601C Report</h2></center>
                                </div>
                                    ...
                                    <div style="margin: 15px;">
                                      <div class="row">
                                          ...
                                          <div class="row" style="margin-top: 25px;">
                                           <div class="col-md-2">
                                               <button type="button" class="btn col-sm-6 form-control" id="print_1601C" style="background-color:#27ae60; color:white;"><i class="fa fa-print"></i> Print</button>
                                           </div>
                                           <div class="col-md-2">
                                               <button type="button" class="btn btn-primary col-sm-6 form-control" id="export_1601C" style="background-color:#27ae60; color:white;"><i class="fa fa-file-excel-o"></i> Export Excel</button>
                                           </div>
                                       </div>
                                        </div>
                                    </div>
...
$(document).ready(function(){
    ...
    var process_1601C_report = function(){
        ...
        "dataType":"html",
        "type":"POST",
        "url":"PayrollReports/payrollreports/report1601C/"+filter_pay_period+"/"+filter_month,
        beforeSend : function(){
    ...
    $('#export_1601C').click(function(){
        filter_pay_period = $('#payperiod_filter').val();
        filter_month = $('#month_filter').val();
        window.open("Report1601C/layout/export_1601C/"+filter_pay_period+"/"+filter_month+"","_self");
    });
