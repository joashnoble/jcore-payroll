                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body table-responsive">
                                    <div style="margin: 20px;">
                                      <div class="row">
                                          <div class="col-md-3">
                                              <label  style="float:left;margin-top:5px;font-weight: bold;" for="inputEmail1">Pay Period :</label>
                                              <select class="form-control" style="margin-left: 20px;" name="payperiod_filter" id="payperiod_filter" data-error-msg="Pay Period is required!" required>
                                                <?php
                                          ...
                                          <div class="col-md-3">
                                              <label  style="float:left;margin-top:5px;font-weight: bold;" for="inputEmail1">Branch:</label>
                                          ...
                                          <div class="col-md-3">
                                            <button type="button" class="btn col-sm-12 form-control" id="print_emp_payroll" style="background-color:#27ae60; color:white;margin-top: 30px;">
