                                ...
                                <div class="panel-body table-responsive" style="padding-top:8px;">
                                    <div class="row" style="margin: 20px;">
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <select class="form-control" name="payperiod_demog_filter" id="payperiod_demog_filter" data-error-msg="Pay Period Filter is required" required>
                                        ...
                                        <div class="col-md-3">
                                            <button type="button" class="btn col-sm-12 form-control" id="print_sched_demography" style="background-color:#27ae60;color:white;margin-top: 25px">
