                                    ...
                                    <div style="margin: 15px;">
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <select class="form-control" name="status_filter" id="status_filter" data-error-msg="Employee Status Filter is required" required> 
                                            ...
                                            <div class="col-md-2">
                                                <button type="button" class="btn col-sm-12 form-control" id="print_alphalist" style="background-color:#27ae60; color:white;margin-top: 25px;width: 100%">
                                                    <i class="fa fa-print"></i> PRINT
                                                </button>
                                            </div>
                                            <div class="col-md-3">
                                                <button id="export-alphalist" style="margin-top: 25px;" class="btn btn-primary">
                                                    <i class="fa fa-file-excel-o"></i> EXPORT ALPHA LIST OF EMPLOYEE TO EXCEL
                                                </button>
                                            </div>
                                        </div>
                                    </div>
...
$(document).ready(function(){
    ...
    var get_alphalist = function(){

        var filter_pay_period = $('#payperiod_filter').val();
        var filter_status = $('#status_filter').val();

        $.ajax({
            "dataType":"html",
            "type":"POST",
            "url":"PayrollReports/payrollreports/alpha_list/"+filter_pay_period+"/"+filter_status,
            beforeSend : function(){
    ...
    $('#export-alphalist').click(function(){
        var filter_pay_period = $('#payperiod_filter').val();
        var filter_status = $('#status_filter').val();
        window.open("AlphaList/schedule/export-alphalist/"+filter_pay_period+"/"+filter_status,"_self");
    });
