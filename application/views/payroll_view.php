...
<head>
    ...
    <style>
        ...
        #tbl_dtr_deduction td:nth-child(3){
                ...
                <div class="page-content">
                    ...
                    <div id="div_dtr_entry" style="display:none;">
                            ...
                            <div class="panel panel-default">
                                ...
                                <button class="btn btn_newdtr add right_dtr_create" id="btn_newdtr" title="Create New DTR" >
                            ...
                            <div class="row">
                              <div class="col-md-6">
                                <div class="form-group" style="margin-bottom:2px; !important">
                                          ...
                                          <select class="form-control" id="ref_department_id" name="ref_department_id">
                              ...
                              <div class="col-md-6">
                                <div class="form-group" style="margin-bottom:2px; !important">
                                          ...
                                          <select class="form-control" id="ref_branch_id" name="ref_branch_id">
                        ...
                        <div class="modal-body" style="padding-top:3px;">
                            ...
                            <div class="row" style="margin-top:2px;">
                              <div class="col-md-3">
                                ...
                                <div style="margin-top:4px;width:5px;height:25px;background-color:#2c3e50;width:100%;text-align:center;color:white;border-radius:5px;">
                                    <p style="padding-top:2px;font-weight:bold;">REST DAY</p>
                                </div>
                                <div class="form-group">
                                      <label class="col-sm-6 inlinecustomlabel-sm2" for="inputPassword1">REST DAY</label>
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control numeric inputcustom" id="day_off" name="day_off" placeholder="Hours" data-error-msg="This Field is Required!">
                                        </div>
                                </div>
                                ...
                                <div class="form-group">
                                      <label class="col-sm-6 inlinecustomlabel-sm2" for="inputPassword1">W/O PAY</label>
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control numeric inputcustom" id="days_wout_pay" name="days_wout_pay" placeholder="Hours" data-error-msg="This Field is Required!">
                                        </div>
                                </div>
                                <div class="form-group">
                                      <label class="col-sm-6 inlinecustomlabel-sm2" for="inputPassword1">W/ PAY</label>
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control numeric inputcustom" id="days_with_pay" name="days_with_pay" placeholder="Hours" data-error-msg="This Field is Required!">
                                        </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                      <label class="col-sm-6 inlinecustomlabel-sm2" for="inputPassword1">UNDERTIME</label>
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control numeric inputcustom" id="minutes_undertime" name="minutes_undertime" placeholder="Minutes" data-error-msg="This Field is Required!">
                                        </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-6 inlinecustomlabel-sm2" style="font-size: 6.5pt;">EXCESS BREAK</label>
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control numeric inputcustom" id="minutes_excess_break" name="minutes_excess_break" placeholder="Minutes" data-error-msg="This Field is Required!">
                                    </div>
                                </div>
                              </div>
                              <div class="col-md-5">
                                ...
                                <div class="form-group">
                                      <label class="col-sm-8 inlinecustomlabel-sm2" for="inputPassword1">REGULAR (Hrs) :</label>
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control numeric inputcustom" id="ot_reg" name="ot_reg" placeholder="Hours" data-error-msg="This Field is Required!">
                                        </div>
                                </div>
                                <div class="form-group">
                                      <label class="col-sm-8 inlinecustomlabel-sm2" for="inputPassword1">REGULAR HOLIDAY (Hrs) :</label>
                                        <div class="col-sm-4">
                                             <input type="text" class="form-control numeric inputcustom" id="ot_reg_reg_hol" name="ot_reg_reg_hol" placeholder="Hours" data-error-msg="This Field is Required!">
                                        </div>
                                </div>
                                <div class="form-group">
                                      <label class="col-sm-8 inlinecustomlabel-sm2" for="inputPassword1">SPECIAL HOLIDAY (Hrs) :</label>
                                        <div class="col-sm-4">
                                             <input type="text" class="form-control numeric inputcustom" id="ot_reg_spe_hol" name="ot_reg_spe_hol" placeholder="Hours" data-error-msg="This Field is Required!">
                                        </div>
                                </div>
                                ...
                                <div class="form-group">
                                      <label class="col-sm-8 inlinecustomlabel-sm2" for="inputPassword1">SUNDAY (Hrs) :</label>
                                        <div class="col-sm-4">
                                             <input type="text" class="form-control numeric inputcustom" id="ot_sun" name="ot_sun" placeholder="Hours" data-error-msg="This Field is Required!">
                                        </div>
                                </div>
                                <div class="form-group">
                                      <label class="col-sm-8 inlinecustomlabel-sm2" for="inputPassword1">REGULAR HOLIDAY (Hrs) :</label>
                                        <div class="col-sm-4">
                                             <input type="text" class="form-control numeric" id="ot_sun_reg_hol" name="ot_sun_reg_hol" placeholder="Hours" data-error-msg="This Field is Required!">
                                        </div>
                                </div>
                                <div class="form-group">
                                      <label class="col-sm-8 inlinecustomlabel-sm2" for="inputPassword1">SPECIAL HOLIDAY (Hrs) :</label>
                                        <div class="col-sm-4">
                                             <input type="text" class="form-control numeric inputcustom" id="ot_sun_spe_hol" name="ot_sun_spe_hol" placeholder="Hours" data-error-msg="This Field is Required!">
                                        </div>
                                </div>
                              ...
                              <div class="col-md-4">
                                ...
                                <div class="form-group">
                                      <label class="col-sm-8 inlinecustomlabel-sm2" for="inputPassword1">REGULAR (Hrs) :</label>
                                        <div class="col-sm-4">
                                             <input type="text" class="form-control numeric inputcustom" id="nsd_reg" name="nsd_reg" placeholder="Hours" data-error-msg="This Field is Required!">
                                        </div>
                                </div>
                                <div class="form-group">
                                      <label class="col-sm-8 inlinecustomlabel-sm2" for="inputPassword1">REGULAR HOLIDAY (Hrs) :</label>
                                        <div class="col-sm-4">
                                             <input type="text" class="form-control numeric inputcustom" id="nsd_reg_reg_hol" name="nsd_reg_reg_hol" placeholder="Hours" data-error-msg="This Field is Required!">
                                        </div>
                                </div>
                                <div class="form-group">
                                      <label class="col-sm-8 inlinecustomlabel-sm2" for="inputPassword1">SPECIAL HOLIDAY (Hrs) :</label>
                                        <div class="col-sm-4">
                                             <input type="text" class="form-control numeric inputcustom" id="nsd_reg_spe_hol" name="nsd_reg_spe_hol" placeholder="Hours" data-error-msg="This Field is Required!">
                                        </div>
                                </div>
                                <hr style="height:2px;background-color:#2c3e50;width:100%;margin:0px;padding:0px;"></hr>
                                <div class="form-group">
                                      <label class="col-sm-8 inlinecustomlabel-sm2" for="inputPassword1">SUNDAY (Hrs) :</label>
                                        <div class="col-sm-4">
                                             <input type="text" class="form-control numeric inputcustom" id="nsd_sun" name="nsd_sun" placeholder="Hours" data-error-msg="This Field is Required!">
                                        </div>
                                </div>
                                <div class="form-group">
                                      <label class="col-sm-8 inlinecustomlabel-sm2" for="inputPassword1">REGULAR HOLIDAY (Hrs) :</label>
                                        <div class="col-sm-4">
                                             <input type="text" class="form-control numeric inputcustom" id="nsd_sun_reg_hol" name="nsd_sun_reg_hol" placeholder="Hours" data-error-msg="This Field is Required!">
                                        </div>
                                </div>
                                <div class="form-group">
                                      <label class="col-sm-8 inlinecustomlabel-sm2" for="inputPassword1">SPECIAL HOLIDAY (Hrs) :</label>
                                        <div class="col-sm-4">
                                             <input type="text" class="form-control numeric inputcustom" id="nsd_sun_spe_hol" name="nsd_sun_spe_hol" placeholder="Hours" data-error-msg="This Field is Required!">
                                        </div>
                                </div>
                              </div>
                              <div class="col-md-9">
                                    <table id="tbl_dtr_deduction" class="table table-striped table-bordered customtable" style="padding:0px !important;margin:0px !important;height: 100%!important;" cellspacing="0" width="100%">
                                            <thead>
                                                <tr>
                                                    <th class="customth" style="width:1px;padding:0px !important;margin:0px !important;"></th>
                                                    <th class="customth" style="width:1px;padding:0px !important;margin:0px !important;"></th>
                                                    ...
                                                    <th class="customth" style="padding:0px !important;margin:0px !important;"><center>Status</center></th>
                                                    <th class="customth" style="padding:0px !important;margin:0px !important;"><center>Is Deduct</center></th>
                                                    <th class="customth" style="padding:0px !important;margin:0px !important;">
                                                        <center>
                                                            Full Deduct
                                                        </center>
                                                    </th>
                                            ...
                                            <tbody id="deduction_body" style="padding:0px !important;margin:0px !important;font-size:8pt;min-height: 400px!important;height: 100%!important;">
...
$(document).ready(function(){
    ...
    var _pay_period_sequence;var _year; var _pay_period; var _refdepartment_id; var _refbranch_id;
    ...
    var initializeControls=function(){
        ...
        $('#year').change(function() {
            ...
            getpayperiod().done(function(response){
                        ...
                        $('#pay_period').html('<option value="">Select Pay Period</option>'+show2select);
    ...
    var bindEventHandlers=(function(){
        ...
        $('#btn_newdtr').click(function(){
            ...
            getempwodtr().done(function(response){
                        ...
                        var jsoncount=response.data.length-1;
                        for(var i=0;parseInt(jsoncount)>=i;i++){
                            show2select+='<option id='+response.data[i].department+' value='+response.data[i].employee_id+'~'+response.data[i].department+'~'+response.data[i].emp_rates_duties_id+'>'+response.data[i].ecode+' ~ '+response.data[i].last_name+', '+response.data[i].first_name+' '+response.data[i].middle_name+'</option>';
                            empdept = response.data[i].department;
                        }
                ...
                "columns": [
                    ...
                    { targets:[4],data: null,
                        render: function (data, type, full, meta){
                            ...
                            if (data.is_deduct == 1){
                                return "<center><input type='checkbox' id='dtr_deduction_checkbox_"+data.deduction_id+"' name='dtr_deduction_checkbox[]' value="+data.deduction_id+" checked></center>";
                            }else{
                                return "<center><input type='checkbox' id='dtr_deduction_checkbox_"+data.deduction_id+"' name='dtr_deduction_checkbox[]' value="+data.deduction_id+"></center>";
                            }
                    ...
                    { targets:[5],data: null,
                        render: function (data, type, full, meta){
                            ...
                            if (data.full_deduct == 1){
                                return "<center><input type='checkbox' id='dtr_full_deduct_checkbox_"+data.deduction_id+"' name='dtr_full_deduct_checkbox[]' value="+data.deduction_id+"></center>";
                            } else{
                                return "";
                            }
            ...
            "columns": [
                ...
                { targets:[5],data: null,
                    render: function (data, type, full, meta){
                            ...
                            if (data.deduction_id <= 3){

                                if (data.full_deduct == 1){
                                    return "<center><input type='checkbox' id='dtr_full_deduct_checkbox' name='dtr_full_deduct_checkbox[]' value="+data.deduction_id+" checked></center>";
                                }
                                else{
                                    return "<center><input type='checkbox' id='dtr_full_deduct_checkbox' name='dtr_full_deduct_checkbox[]' value="+data.deduction_id+"></center>";
                                }       
