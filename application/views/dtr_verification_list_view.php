                ...
                <div class="modal-dialog modal-lg reports">
                    <div class="modal-content reports-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button id="print_verificationlist" type="button" class="btn btn-success"> <i class="fa fa-print"></i> PRINT</button>
                            <button id="export_verificationlist" type="button" class="btn btn-primary"> <i class="fa fa-file-excel-o"></i> EXPORT EXCEL</button>
                            <button id="email_verificationlist" type="button" class="btn btn-info"> <i class="fa fa-envelope"></i> EMAIL</button>
...
$(document).ready(function(){
    ...
    $('#export_verificationlist').on('click', function() {
        var _deptId = $('#ref_department_id').val();
        var _brachId = $('#ref_branch_id').val();

        window.open("DtrReports/dtrreports/export-dtr-verification-list/"+_selectedYear+"/"+_deptId+"/"+_brachId+"","_self");
    });

    $('#email_verificationlist').on('click', function() {
        var _deptId = $('#ref_department_id').val();
        var _brachId = $('#ref_branch_id').val();
    ...
    $.ajax({
        "dataType":"json",
        "type":"POST",
        "url":"DtrReports/dtrreports/email-dtr-verification-list/"+_selectedYear+"/"+_deptId+"/"+_brachId+"",
