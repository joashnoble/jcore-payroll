                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                              <div class="col-md-12">
                                <div class="form-group" style="margin-bottom:0px;">
                                    <label class="boldlabel"> <span class="red"><b>*</b></span> Period Start :</label>
                            ...
                            <div class="row">
                              <div class="col-md-12">
                                <div class="form-group" style="margin-bottom:0px;">
                                    <label class="boldlabel"> <span class="red"><b>*</b></span> Period End :</label>
                            ...
                            <div class="row">
                              <div class="col-md-12">
                                <div class="form-group" style="margin-bottom:0px;">
                                    <label class="boldlabel"> <span class="red"><b>*</b></span> Period :</label>
                            ...
                            <div class="row">
                              <div class="col-md-12">
                                <div class="form-group" style="margin-bottom:0px;">
                                    <label class="boldlabel"> <span class="red"><b>*</b></span> Applicable Month :</label>
                            ...
                            <div class="row">
                              <div class="col-md-12">
                                <div class="form-group" style="margin-bottom:0px;">
                                    <label class="boldlabel"> <span class="red"><b>*</b></span> Applicable Year :</label>
                                    <select class="form-control" id="pay_period_year" name="pay_period_year" data-error-msg="Year is required!" required>
...
$(document).ready(function(){
    ...
    var _pay_period; var _month; var _year;
    ...
    var initializeControls=function(){
        ...
        _month.val(null).trigger("change");

        _pay_period=$("#pay_period_sequence").select2({
            dropdownParent: $("#modal_create_payperiod"),
            placeholder: "Select Period Cycle",
            allowClear: false
        });

        _pay_period.val(null).trigger("change");
    ...
    var bindEventHandlers=(function(){
        ...
        $('#tbl_payperiod_list tbody').on('click','button[name="edit_info"]',function(){
            ...
            _month.val(data.month_id).trigger("change");
            _year.val(data.pay_period_year).trigger("change");
            _pay_period.val(data.pay_period_sequence).trigger("change");
