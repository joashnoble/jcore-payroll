                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                              <div class="col-md-12">
                                <div class="form-group" style="margin-bottom:0px;">
                                    <label class="boldlabel"> <span class="red"><b>*</b></span> Deduction Type :</label>
...
$(document).ready(function(){
    var dt; var _txnMode; var _selectedID; var _selectRowObj; var _deduction_type;
    ...
    var initializeControls=function(){
        ...
        _deduction_type=$("#deduction_type_id").select2({
            dropdownParent: $("#modal_create_Deduction"),
            placeholder: "Select Deduction Type",
            allowClear: false
        });

        _deduction_type.val(null).trigger("change");
    ...
    var bindEventHandlers=(function(){
        ...
        $('#tbl_deduction_list tbody').on('click','button[name="edit_info"]',function(){
            ...
            _deduction_type.val(data.deduction_type_id).trigger("change");
