	<script>
        ...
        var right_clearancereason_edit="<button type='button' name='edit_info' class='btn btn-primary' style='margin-right: 5px;'><i class='fa fa-pencil'></i></button>";
        var right_clearancereason_delete="<button type='button' name='remove_info' class='btn btn-danger' style='margin-right: 5px;'><i class='fa fa-trash'></i></button>";

        var right_employeeclearance_finalize="<button type='button' name='btn_finalize' class='btn btn-success' style='margin-right: 5px;font-weight: 500!important;'><i class='fa fa-check-circle'></i> FINALIZE</button>";
        var right_employeeclearance_edit = "<button type='button' name='btn_update' class='btn btn-primary' style='margin-right: 5px;'><i class='fa fa-edit'></i></button>";
        var right_employeeclearance_delete = "<button type='button' name='btn_remove' class='btn btn-danger' style='margin-right: 5px;'><i class='fa fa-trash'></i></button>";
	</script>
...
<?php
    ...
    echo ($this->session->right_backup_restore==0 || NULL ? '<script> var right_backup_restore=" "; </script>' : '');
        ...
        echo ($this->session->right_payroll_register_waccount_view==0 || NULL ? '<script> $(".right_payroll_register_waccount_view").remove(); </script>' : '');
        echo ($this->session->right_payroll_register_cash_view1==0 || NULL ? '<script> $(".right_payroll_register_cash_view1").remove(); </script>' : '');   


        echo ($this->session->right_payrollsummary_view==0 || NULL ? '<script> $(".right_payrollsummary_view").remove(); </script>' : '');   

        echo ($this->session->right_clearancereason_view==0 || NULL ? '<script> $(".right_clearancereason_view").remove(); </script>' : '');
        echo ($this->session->right_clearancereason_create==0 || NULL ? '<script> $(".right_clearancereason_create").remove(); </script>' : '');

        echo ($this->session->right_clearancereason_edit==0 || NULL ? '<script> var right_clearancereason_edit=" "; </script>' : '');
        echo ($this->session->right_clearancereason_delete==0 || NULL ? '<script> var right_clearancereason_delete=" "; </script>' : '');

        echo ($this->session->right_employeeclearance_view==0 || NULL ? '<script> $(".right_employeeclearance_view").remove(); </script>' : '');
        echo ($this->session->right_employeeclearance_create==0 || NULL ? '<script> $(".right_employeeclearance_create").remove(); </script>' : '');

        echo ($this->session->right_employeeclearance_edit==0 || NULL ? '<script> var right_employeeclearance_edit=" "; </script>' : '');
        echo ($this->session->right_employeeclearance_delete==0 || NULL ? '<script> var right_employeeclearance_delete=" "; </script>' : '');
        echo ($this->session->right_employeeclearance_finalize==0 || NULL ? '<script> var right_employeeclearance_finalize=" "; </script>' : '');
