...
<!-- 				<td align="center"><?php //echo number_format($row->coopcontribution_deduction,2); ?></td>
				...
				<td align="center"><?php 
									echo number_format($row->days_wout_pay_amt+$row->minutes_late_amt+$row->sss_deduction+$row->philhealth_deduction+$row->pagibig_deduction+$row->wtax_deduction+$row->sssloan_deduction+$row->pagibigloan_deduction+$row->cashadvance_deduction/*+$row->calamityloan_deduction+$atoe1[0]->total_atoe1+$atoe2[0]->total_atoe2+$atoe3[0]->total_atoe3*/+$otherdeduct[0]->total_other_deductions,2);
									?></td>
				<td align="center"><?php 
									echo number_format($row->gross_pay-($row->days_wout_pay_amt+$row->minutes_late_amt+$row->sss_deduction+$row->philhealth_deduction+$row->pagibig_deduction+$row->wtax_deduction+$row->sssloan_deduction+$row->pagibigloan_deduction+$row->cashadvance_deduction/*+$row->calamityloan_deduction+$atoe1[0]->total_atoe1+$atoe2[0]->total_atoe2+$atoe3[0]->total_atoe3*/+$otherdeduct[0]->total_other_deductions),2);
									?></td>					                                
			</tr>
			<?php
				...
				$s_deductions += $row->days_wout_pay_amt+$row->minutes_late_amt+$row->sss_deduction+$row->philhealth_deduction+$row->pagibig_deduction+$row->wtax_deduction+$row->sssloan_deduction+$row->pagibigloan_deduction+$row->cashadvance_deduction/*+$row->calamityloan_deduction+$atoe1[0]->total_atoe1+$atoe2[0]->total_atoe2+$atoe3[0]->total_atoe3*/+$otherdeduct[0]->total_other_deductions;
				$salaries_wages = $gross_pay-$s_deductions;
					...
					<tr style="height:7px;">
						<td colspan="5" style="font-family:tahoma;font-weight:bold;font-size:12pt;">
							...
							Day Off Pay : <?php echo number_format($day_off_pay,2); ?><br>
