...
<table style="width:100%;border:1px solid black;font-family: tahoma;border-top:0;border-left:0;font-size:11px;">
	<thead>
		...
		<tr>
			<td>
				<p style="font-weight:bold;">Total Late (Minutes)</p>
			</td>
			<td align="right">
				<p style="font-weight:bold;"><?php echo number_format($payslip->minutes_late,2); ?></p>
			</td>
		</tr>
