...
<!-- 				<th style="text-align:center;">Coop Contri.</th>
		...
		<tbody>
			...
			<tr>
				...
				<td align="center"><?php echo number_format($row->days_wout_pay_amt+$row->minutes_late_amt+$row->minutes_undertime_amt+$row->minutes_excess_break_amt,2); ?></td>
...
<!-- 				<td align="center"><?php //echo number_format($row->coopcontribution_deduction,2); ?></td>
        ...
        <td align="center"><?php echo $total_other_deductions=number_format($row->other_deductions,2); ?></td>
				<td align="center"><?php
									echo number_format($row->days_wout_pay_amt+$row->minutes_late_amt+$row->minutes_undertime_amt+$row->minutes_excess_break_amt+$row->sss_deduction+$row->philhealth_deduction+$row->pagibig_deduction+$row->wtax_deduction+$row->sssloan_deduction+$row->pagibigloan_deduction+$row->cashadvance_deduction+$row->calamityloan_deduction+$total_other_deductions,2);
									?></td>
				<td align="center"><?php
									echo number_format($row->gross_pay-($row->days_wout_pay_amt+$row->minutes_late_amt+$row->minutes_undertime_amt+$row->minutes_excess_break_amt+$row->sss_deduction+$row->philhealth_deduction+$row->pagibig_deduction+$row->wtax_deduction+$row->sssloan_deduction+$row->pagibigloan_deduction+$row->cashadvance_deduction+$row->calamityloan_deduction+$total_other_deductions),2);
									?></td>
			</tr>
			<?php
				...
				$absences_late += $row->days_wout_pay_amt+$row->minutes_late_amt+$row->minutes_undertime_amt+$row->minutes_excess_break_amt;
				...
				$s_deductions += $row->days_wout_pay_amt+$row->minutes_late_amt+$row->minutes_undertime_amt+$row->minutes_excess_break_amt+$row->sss_deduction+$row->philhealth_deduction+$row->pagibig_deduction+$row->wtax_deduction+$row->sssloan_deduction+$row->pagibigloan_deduction+$row->cashadvance_deduction+$row->calamityloan_deduction+$total_other_deductions;
