	...
	<!-- 				<td align="right"><?php echo number_format($row->coopcontribution_deduction,2); ?></td>
	        ...
	        <td align="center"><?php echo number_format($row->other_deductions,2); ?></td>
					<td align="center"><?php
										echo number_format($row->days_wout_pay_amt+$row->minutes_late_amt+$row->sss_deduction+$row->philhealth_deduction+$row->pagibig_deduction+$row->wtax_deduction+$row->sssloan_deduction+$row->pagibigloan_deduction+$row->cashadvance_deduction+$row->calamityloan_deduction+$row->other_deductions,2);
										?></td>
					<td align="center"><?php
										echo number_format($row->gross_pay-($row->days_wout_pay_amt+$row->minutes_late_amt+$row->sss_deduction+$row->philhealth_deduction+$row->pagibig_deduction+$row->wtax_deduction+$row->sssloan_deduction+$row->pagibigloan_deduction+$row->cashadvance_deduction+$row->calamityloan_deduction+$row->other_deductions),2);
										?></td>
				</tr>
				<?php
