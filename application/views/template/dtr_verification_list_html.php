...
<table>
	...
	<tr>
		<td style="font-size:16px;">Pay Period : <?php echo $pay_period; ?></td>
	</tr>
	<tr>
	...
	<table class="table">
		<thead class="thead-inverse" style="background-color:#2c3e50;color:white;">
			<tr>
				<th style="border:1px solid black;border-top:1px solid black;border-right:0px;"></th>
				<th style="border:1px solid black;border-top:1px solid black;border-right:0px;"></th>
				<th style="border:1px solid black;border-top:1px solid black;text-align:left;border-right:0px;border-left:0px;"></th>
				<th style="border:1px solid black;border-top:1px solid black;border-right:0px;border-left:0px;"></th>
				<th style="border:1px solid black;border-top:1px solid black;border-right:0px;border-left:0px;"></th>
				<th style="border:1px solid black;border-top:1px solid black;border-right:0px;border-left:0px;"></th>
				<th colspan="2" style="text-align:border-top:1px solid black;center;border:1px solid black;">Holidays</th>
				<th colspan="2" style="text-align:border-top:1px solid black;center;border:1px solid black;">Sunday Holidays</th>
				<th colspan="2" style="text-align:border-top:1px solid black;center;border:1px solid black;">Excused Leave</th>
				<th colspan="2" style="border:1px solid black;border-top:1px solid black;"></th>
				<th colspan ="6" style="text-align:center;border-top:1px solid black;border:1px solid black;">Overtime</th>
				<th colspan="6" style="text-align:center;border-top:1px solid black;border:1px solid black;">Night Shift Differential</th>
			</tr>
			<tr>
			...
			<tr>
				...
				<th style="text-align:center;border:1px solid black;">Day Off</th>
				<th style="text-align:center;border:1px solid black;">Reg</th>
				<th style="text-align:center;border:1px solid black;">Sun</th>
				<th style="text-align:center;border:1px solid black;">Reg</th>
				<th style="text-align:center;border:1px solid black;">Sun</th>
				...
				<th style="text-align:center;border:1px solid black;">Minutes Undertime</th>
				<th style="text-align:center;border:1px solid black;">Reg</th>
		...
		<tbody>
			...
			<tr>
				...
				<td style="text-align:center;;"><?php echo $verificationlist->day_off ?></td>
				...
				<td style="text-align:center;;"><?php echo $verificationlist->minutes_undertime ?></td>
