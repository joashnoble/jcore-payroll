                                ...
                                <center>   
                                  <div class="col-md-2">
                                    <div class="form-group" style="margin-bottom:0px;">
                                        ...
                                        <input type="checkbox" class="form-control" id="check1" name="sequence[]" value="1">
                                    </div>
                                  </div>
                                  <div class="col-md-2">
                                    <div class="form-group" style="margin-bottom:0px;">
                                        <label class="boldlabel">2 :</label>
                                        <input type="checkbox" class="form-control" id="check2" name="sequence[]" value="2">
                                    </div>
                                  </div>
                                  <div class="col-md-2">
                                    <div class="form-group" style="margin-bottom:0px;">
                                        <label class="boldlabel">3 :</label>
                                        <input type="checkbox" class="form-control" id="check3" name="sequence[]" value="3">
                                    </div>
                                  </div>
                                  <div class="col-md-2">
                                    <div class="form-group" style="margin-bottom:0px;">
                                        <label class="boldlabel">4 :</label>
                                        <input type="checkbox" class="form-control" id="check4" name="sequence[]" value="4">
                                    </div>
                                  </div>
                                  <div class="col-md-2">
                                    <div class="form-group" style="margin-bottom:0px;">
                                        <label class="boldlabel">5 :</label>
                                        <input type="checkbox" class="form-control" id="check5" name="sequence[]" value="5">
                                    </div>
                                  </div>
                                </center>
                            </div>
...
$(document).ready(function(){
    ...
    var initializeControls=function(){
        dt=$('#tbl_advanced_settings').DataTable({
            ...
            "columns": [
                { targets:[0],data: "deduction_desc" },
                { targets:[1],data: getCheck1 },
                { targets:[2],data: getCheck2 },
                { targets:[3],data: getCheck3 },
                { targets:[4],data: getCheck4 },
                { targets:[5],data: getCheck5 },
                {
                    targets:[6],
                ...
                { targets:[7],data: "deduction_id", visible:false}
            ],
